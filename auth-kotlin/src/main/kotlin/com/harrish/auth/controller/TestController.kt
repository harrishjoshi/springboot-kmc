...
class TestController {
    ...
    @GetMapping("/public")
    fun publicEndpoint(): ResponseEntity<MessageResponse> {
        return ResponseEntity.ok(MessageResponse("This is a public endpoint"))
    }
    ...
    fun protectedEndpoint(): ResponseEntity<UserInfoResponse> {
    ...
    fun adminEndpoint(): ResponseEntity<MessageResponse> {
        return ResponseEntity.ok(MessageResponse("This is an admin endpoint"))
    }
